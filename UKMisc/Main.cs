...
namespace UKMisc
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        float NAILSliderX = 0f, NAILSliderY = 0f;
        int i = 0;
        ...
        public Rect MenuWindow = new Rect(60, 400, 400, 10000);
        Font fnt;
        AssetBundle Bundle = Plugin.LoadAssetBundle(Properties.Resources.uibundle);
        Texture2D UISKIN, UISKINBT;
        GUIStyle STY,STYB, _STY, _STYB,AMO,AMOB,AMOSTY,AMOSTYB,MNU,_UI,_UIBT,WAR,WARB;
        ...
        private void HUDConfig()
        {
            ...
            AmmoposX = Config.Bind("Ammo Counter", "NaiAmmo Counter X pos", 1455f, "");
            AmmoposY = Config.Bind("Ammo Counter", "NaiAmmo Counter Y pos", 980f, "");
        }
        ...
        public void Start()
        {
            ...
            fnt = Bundle.LoadAsset<GameObject>("FONT").GetComponent<Text>().font;
        }
        public void Update()
        {
                ...
                case true:
                    switch (i)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            Rect ToolsWindow = GUI.Window(1, MenuWindow, UI, "", STY);
                            break;
                        case 2:
                            Rect ModWindow = GUI.Window(2, MenuWindow, UI, "", STY);
                            break;
                        case 3:
                            Rect HUDWindow = GUI.Window(3, MenuWindow, UI, "", STY);
                            break;
                        case 4:
                            Rect NAILWindow = GUI.Window(4, MenuWindow, UI, "", STY);
                            break;
                    }
                    break;
                default:
                ...
                if (WC != null)
                {
                    ...
                    switch (wc)
                    {
                        case null:
                            break;
                        default:
                            Text("NAILS", new Rect(AmmoposX.Value, AmmoposY.Value-15, 300, 100), AMOSTY, AMOSTYB);
                            Text(Mathf.RoundToInt(wc.naiAmmo).ToString(), new Rect(AmmoposX.Value, AmmoposY.Value+30,300,100), AMO, AMOB);
                            Text("HEATSINKS", new Rect(AmmoposX.Value+155, AmmoposY.Value-15, 300, 100), AMOSTY, AMOSTYB);
                            Text( wc.nai0charge.ToString(), new Rect(AmmoposX.Value+155, AmmoposY.Value+30, 300, 100), AMO, AMOB);
                            break;
                    }
                }
            }
        ...
        private void Styles()
        {
            ...
            {
                case null:
                    _STY = new GUIStyle(); _STY.font = fnt; _STY.fontSize = 20; _STY.normal.textColor = Color.white;
                    break;
                default:
                    break;
            }
            ...
            {
                case null:
                    _STYB = new GUIStyle(); _STYB.font = fnt; _STYB.fontSize = _STY.fontSize; _STYB.normal.textColor = Color.black;
                    break;
                default:
                    break;
            }
            ...
            {
                case null:
                    AMO = new GUIStyle(); AMO.font = fnt; AMO.fontSize = 46; AMO.normal.textColor = AmmoMain.Value;
                    break;
                default:
                    break;
            }
            ...
            {
                case null:
                    AMOSTY = new GUIStyle(); AMOSTY.font = fnt; AMOSTY.fontSize = 36; AMOSTY.normal.textColor = Color.white;
                    break;
                default:
                    break;
            }
            ...
            {
                case null:
                    AMOSTYB = new GUIStyle(); AMOSTYB.font = fnt; AMOSTYB.fontSize = AMOSTY.fontSize; AMOSTYB.normal.textColor = Color.black;
                    break;
                default:
                    break;
            }
        ...
        private void Text(string txt, Rect pos, GUIStyle main, GUIStyle back)
        {
            ...
            GUI.Label(new Rect(pos.x+1f,pos.y-1f,pos.width,pos.height), txt, back);
        ...
        public void UI(int WindowID)
        {
            switch (WindowID)
            {
                case 0:
                    ...
                    if (GUI.Button(new Rect(5, 20, UISKINBT.width, UISKINBT.height / 2), "Toggle Test Mode", _UIBT))
                    {
                        testrdy = !testrdy;
                    }
                    if (GUI.Button(new Rect(5, 60, UISKINBT.width, UISKINBT.height / 2), "Game Modifiers", _UIBT))
                    {
                        i = 1;
                    }
                    if (GUI.Button(new Rect(5, 100, UISKINBT.width, UISKINBT.height / 2), "Tools", _UIBT))
                    {
                        i = 2;
                    }
                    break;
                case 1:
                    ...
                    if (GUI.Button(new Rect(5, 20, UISKINBT.width, UISKINBT.height / 2), "Back", _UIBT))
                    {
                        i = 0;
                    }
                    if (GUI.Button(new Rect(5, 60, UISKINBT.width, UISKINBT.height / 2), "Sand Mode", _UIBT))
                    {
                        sandrdy = !sandrdy;
                    }
                    if (GUI.Button(new Rect(5, 100, UISKINBT.width, UISKINBT.height / 2), "Toggle Vampire hook", _UIBT))
                    {
                        hookrdy = !hookrdy;
                    }
                    break;
                case 2:
                    ...
                    if (GUI.Button(new Rect(5, 60, UISKINBT.width, UISKINBT.height / 2), "Hud Options", _UIBT))
                    {
                        i = 3;
                    }
                    break;
                case 3:
                    GUI.Box(new Rect(0, 0, 250, 200), "HUD", _UI);
                    if (GUI.Button(new Rect(5, 20, UISKINBT.width, UISKINBT.height / 2), "Back", _UIBT))
                    {
                        i = 0;
                    }
                    if (GUI.Button(new Rect(5, 60, UISKINBT.width, UISKINBT.height / 2), "Nail Ammo Counter", _UIBT))
                    {
                        i = 4;
                    }
                    break;
                case 4:
                    GUI.Box(new Rect(0, 0, 250, 600), "NAIL COUNTER", _UI);
                    if (GUI.Button(new Rect(5, 20, UISKINBT.width, UISKINBT.height / 2), "Back", _UIBT))
                    { 
                        i = 3;
                    }
                    if (GUI.Button(new Rect(5, 60, UISKINBT.width, UISKINBT.height / 2), "Toggle", _UIBT))
                    {
                        ammordy = !ammordy;
                    }
                    if (GUI.Button(new Rect(5, 100, UISKINBT.width, UISKINBT.height / 2), "AmmoPosX+0.5", _UIBT)) 
                    {
                        AmmoposX.Value += .5f;
                    }
                    if (GUI.Button(new Rect(5, 140, UISKINBT.width, UISKINBT.height / 2), "AmmoPosY+0.5", _UIBT))
                    {
                        AmmoposY.Value += .5f;
                    }
                    if (GUI.Button(new Rect(5, 180, UISKINBT.width, UISKINBT.height / 2), "AmmoPosX-0.5", _UIBT))
                    {
                        AmmoposX.Value -= .5f;
                    }
                    if (GUI.Button(new Rect(5, 220, UISKINBT.width, UISKINBT.height / 2), "AmmoPosY-0.5", _UIBT))
                    {
                        AmmoposY.Value -= .5f;
                    }
                    if (GUI.Button(new Rect(5, 260, UISKINBT.width, UISKINBT.height / 2), "AmmoPosX+1", _UIBT))
                    {
                        AmmoposX.Value++;
                    }
                    if (GUI.Button(new Rect(5, 300, UISKINBT.width, UISKINBT.height / 2), "AmmoPosY+1", _UIBT))
                    {
                        AmmoposY.Value++;
                    }
                    if (GUI.Button(new Rect(5, 340, UISKINBT.width, UISKINBT.height / 2), "AmmoPosX-1", _UIBT))
                    {
                        AmmoposX.Value--;
                    }
                    if (GUI.Button(new Rect(5, 380, UISKINBT.width, UISKINBT.height / 2), "AmmoPosY-1", _UIBT))
                    {
                        AmmoposY.Value--;
                    }
                    if (GUI.Button(new Rect(5, 420, UISKINBT.width, UISKINBT.height / 2), "AmmoPosX+/- "+ (int)NAILSliderX, _UIBT))
                    {
                        AmmoposX.Value += (int)NAILSliderX;
                    }
                    if (GUI.Button(new Rect(5, 460, UISKINBT.width, UISKINBT.height / 2), "AmmoPosY+/- "+ (int)NAILSliderY, _UIBT))
                    {
                        AmmoposY.Value += (int)NAILSliderY;
                    }
                    if (GUI.Button(new Rect(5, 500, UISKINBT.width, UISKINBT.height / 2), "Reset", _UIBT))
                    {
                        AmmoposY.Value = Screen.height / 2; 
                        AmmoposX.Value = Screen.width / 2;
                    }
                    Text("X", new Rect(5, 540, 220, 40), _STY, _STYB);
                    NAILSliderX = GUI.HorizontalSlider(new Rect(20, 540, 220, 40),NAILSliderX,-100,100);
                    Text("Y", new Rect(5, 580, 220, 40), _STY, _STYB);
                    NAILSliderY = GUI.HorizontalSlider(new Rect(20, 580, 220, 40), NAILSliderY, -100, 100);
                    break;
            }
        }
